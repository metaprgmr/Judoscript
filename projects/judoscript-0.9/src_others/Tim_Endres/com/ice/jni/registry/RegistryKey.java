...
RegistryKey
	...
	/**
	 * Obtains an enerator for the subkeys of this key.
	 *
	 * @return The key enerator.
	 *
     * @exception  RegistryException  Any valid registry API error.
	 */
	...
	/**
	 * Obtains an enerator for the values of this key.
	 *
	 * @return The value enerator.
	 *
     * @exception  RegistryException  Any valid registry API error.
	 */
	...
	/**
	 * Returns a new Enumeration that will enerate the 
	 * names of the subkeys of this key,
	 *
	 * @return A new Enumeration to enerate subkey names.
	 *
     * @exception  RegistryException  Any valid registry API error.
	 */
	 ...
	 *
	 * @return A new Enumeration to enerate value names.
	 *
     * @exception  RegistryException  Any valid registry API error.
	 */
	...
	/**
	 * A RegistryKey enerator class. This enerator
	 * is used to enerate the names of this key's subkeys.
	 *
	...
	/**
	 * A RegistryValue enerator class. This enerator
	 * is used to enerate the names of this key's values.
