...
public class FTPClient {
     ...
     *  Revision control id
     */
    private static String cvsId = "$Id: FTPClient.java,v 1.1.1.1 2002/03/27 23:42:04 judoscript Exp $";
     ...
     *
     *  @param  mode: "ACTIVE" or "PASV".
     */
    public void setConnectMode(String mode) {

        connectMode = mode.equals("ACTIVE") ? FTPConnectMode.ACTIVE : FTPConnectMode.PASV;
    }
