...
/**
 * Writes build events to a PrintWrite. Currently, it
 * only writes which targets are being executed, and
 * any messages that get logged.
 *
 * @author Matt Foemmel
 */
public class AntWriterLogger implements BuildListener {
    /** 
     ...
     * Sole constructor.
     */
    public AntWriterLogger(PrintWriter out, PrintWriter err) {
      this.out = out;
      this.err = err;
    }
     ...
     */
    public void setOutputPrintStream(PrintWriter out) {
        this.out = out;
    }
     ...
     *            Must not be <code>null</code>.
     */
    public void setErrorPrintStream(PrintWriter err) {
        this.err = err;
    }
     ...
     * @param stream   A PrintWriter to print the message to. 
     *                 Must not be <code>null</code>.
