...
public final class ASTMacroIf extends ASTMacroBase
{
  String id = null; // to match begin/end macros. Also used as label prefix.
  boolean hasElse = false;

  public ASTMacroIf(int id) {
    super(id);
  }

  public ASTMacroIf(JamaicaParser p, int id) {
    super(p, id);
  }

  public void setOperator(String t) { text = t; }
  public String getOperator() { return text ; }

  public void setID(String s) { id = s; }
  public String getID() { return id; }

  public void setElse(ASTMacroIf opener) { id = opener.id; text = "else"; opener.hasElse = true; }
  public boolean isElse() { return "else".equals(text); }
  public boolean hasElse() { return hasElse; }

  public void setIsEnd(ASTMacroIf opener) { id = opener.id; text = null; }
  public boolean isEnd() { return text==null; }
