...
/**
 * Bytecode instructions for <code>iinc multianewarray</code>
 * and <code>bipush sipush</code>.
 */
public class ASTCodeWithTextInt extends ASTCodeWithText
{
  int amount = 0;

  public ASTCodeWithTextInt(int id) {
    super(id);
  }

  public ASTCodeWithTextInt(JamaicaParser p, int id) {
    super(p, id);
  }
