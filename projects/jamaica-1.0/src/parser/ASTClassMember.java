...
public abstract class ASTClassMember extends SimpleNode
{
  int accessFlags = 0;
  String name = null;
  String type = null;
  ...
  public ASTClassMember(JamaicaParser p, int id) {
    super(p, id);
  }
  ...
  public void setName(String s, int line) { name = s; lineNum = line; }
